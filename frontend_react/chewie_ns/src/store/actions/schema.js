...
export const fetchSchemaAlleleModeSuccess = (
  mode_data,
  total_allele_data,
  scatter_data,
  mode_data2
    ...
    axios
      ...
      .then((res) => {
        ...
        for (let key in res.data.scatter_data) {
          ...
          scatter_data_min.push(res.data.scatter_data[key].alleles_min);
          scatter_data_max.push(res.data.scatter_data[key].alleles_max);
        }
        scatter_data.push(
          {
            x: scatter_data_min,
